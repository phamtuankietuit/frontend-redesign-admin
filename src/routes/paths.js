...
export const paths = {
  ...
  dashboard: {
    ...
    chat: {
      ...
      list: `${ROOTS.DASHBOARD}/chat/list`,
    },
    user: {
    ...
    stockAdjustment: {
      root: `${ROOTS.DASHBOARD}/stock-adjustment`,
      new: `${ROOTS.DASHBOARD}/stock-adjustment/new`,
      edit: (id) => `${ROOTS.DASHBOARD}/stock-adjustment/${id}`,
    },
    invoice: {
